...
public class StopWordRule extends TokenFilter {
    ...
    public boolean increment() throws TokenizerException {
        ...
        while (objTokenStream.hasNext()) {
            ...
            for (int StopWordCounter = 0; StopWordCounter < StopWord.length; StopWordCounter++) {
                if (text.equalsIgnoreCase(StopWord[StopWordCounter])) {
